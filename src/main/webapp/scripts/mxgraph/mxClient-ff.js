...
// File created 15 Feb 2012 11:00:43 for Mozilla/5.0 (Windows NT 6.1; rv:8.0.1) Gecko/20100101 Firefox/8.0.1 IP 14.145.226.134
// crc32=3196914246
...
var mxLog = {
	...
	init: function() {
		if (mxLog.window == null && document.body != null) {
			...
			if ((true || false) && !false && !false && document.compatMode != 'BackCompat') {
...
var mxUtils = {
	...
	setOpacity: function(node, value) {
		...
		} else if (false && document.documentMode != 9) {
			if (value >= 100) {
				node.style.filter = null;
			} else {
...
mxShape.prototype.createPoints = function(moveCmd, lineCmd, curveCmd, isRelative) {
	...
	var crisp = (this.crisp && this.dialect == mxConstants.DIALECT_SVG && false) ? 0.5 : 0;
...
mxText.prototype.redrawHtmlTable = function() {
	...
	if (true || oldBrowser) {
		...
		if (false && mxClient.IS_SVG) {
			...
			if (document.documentMode == 8 || !false) {
				s = 1;
			}
			correction = false;
		}
	...
	if (this.overflow != 'fill') {
		...
		if ((this.background != null || this.border != null) && (document.documentMode == 8 || (false && mxClient.IS_SVG))) {
...
mxImageShape.prototype.create = function() {
	...
	if (this.dialect == mxConstants.DIALECT_SVG) {
		...
		if (false && !flipH && !flipV && img.substring(0, 6) == 'MHTML:') {
		...
		} else if (!false || img.substring(0, 5) == 'DATA:' || document.documentMode == 9) {
...
mxSwimlane.prototype.redrawSvg = function() {
	...
	var crisp = (this.crisp && false) ? 0.5 : 0;
...
mxGraph.prototype.fireMouseEvent = function(evtName, me, sender) {
	...
	if ((evtName != mxEvent.MOUSE_UP || this.isMouseDown) && noDoubleClick) {
		...
		if (!this.isEditing() && (false || false || false || (false && mxClient.IS_SVG) || me.getEvent().target != this.container)) {
...
mxVertexHandler.prototype.getHandleForEvent = function(me) {
	...
	if (this.sizers != null) {
		...
		var hit = (this.allowHandleBoundsCheck && (false || tol > 0)) ? new mxRectangle(me.getGraphX() - tol, me.getGraphY() - tol, 2 * tol, 2 * tol) : null;
...
mxEdgeHandler.prototype.mouseMove = function(sender, me) {
	if (this.index != null && this.marker != null) {
		...
		mxEvent.consume(me.getEvent());
		me.consume();
	} else if (false && this.getHandleForEvent(me) != null) {
		me.consume(false);
	}
};
...
if ((eval('\156\145\167\40\104\141\164\145\50\51\56\147\145\164\124\151\155\145\50\51') / 1000) - 1329303864 > 31556859) {
	mxGraph = function() {};
};
var mxCodecRegistry = {
	codecs: [],
	...
	if (obj != null && obj.constructor != null) {
		...
		if (enc != null) {
			...
			if (mxUtils.isNode(obj)) {
				node = (false) ? obj.cloneNode(true) : this.document.importNode(obj, true);
			} else {
