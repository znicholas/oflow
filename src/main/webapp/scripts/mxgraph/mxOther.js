...
mxEditor.prototype.showTasks = function() {
	if (this.tasks == null) {
		...
		if (this.tasksWindowImage != null) {
			var imageSrc = this.tasksWindowImage;
			if (mxBasePath) {
				imageSrc = mxBasePath +"/"+this.tasksWindowImage;
			}
			wnd.setImage(imageSrc);
		}
		this.tasks = wnd;
		this.createTasks(div);
	}
...
mxEditor.prototype.showHelp = function(tasks) {
	if (this.help == null) {
		...
		var urlHelp = mxResources.get('urlHelp') || this.urlHelp;
		if (mxBasePath) {
			urlHelp = mxBasePath + "/" + urlHelp;
		}
		
		frame.setAttribute('src', urlHelp);
		...
		if (this.helpWindowImage != null) {
			if (mxBasePath) {
				wnd.setImage(mxBasePath +"/"+this.helpWindowImage);
			} else {
